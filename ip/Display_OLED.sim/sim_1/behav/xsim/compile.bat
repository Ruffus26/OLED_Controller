...
REM
REM Generated by Vivado on Tue Jun 21 14:00:26 +0300 2022
...
echo "xvlog --incr --relax -prj oledController_vlog.prj"
call xvlog  --incr --relax -prj oledController_vlog.prj -log xvlog.log
