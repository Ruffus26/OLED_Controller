...
HD_PWD='C:/Users/User/Desktop/ZedboardOLED/ip/Display_OLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oledController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oledController.tcl
