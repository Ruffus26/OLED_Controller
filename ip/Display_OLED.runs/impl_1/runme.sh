...
HD_PWD='C:/Users/User/Desktop/ZedboardOLED/ip/Display_OLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oledController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oledController.tcl -notrace
